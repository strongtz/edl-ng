...
{
    internal class ErasePartitionCommand
    {
            ...
            uint? specifiedLun)
        {
            ...
            try
            {
                ...
                ulong partStartSectorUlong = foundPartition.Value.FirstLBA;
                ulong partLastSectorUlong = foundPartition.Value.LastLBA;
                ulong numSectorsToEraseUlong = partLastSectorUlong - partStartSectorUlong + 1;
                ...
                uint startSector = (uint)partStartSectorUlong;
                uint numSectorsToErase = (uint)numSectorsToEraseUlong;
                ...
                Stopwatch eraseStopwatch = Stopwatch.StartNew();
